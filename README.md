...
Данный шаблон был разработан на основе шаблона компании "Роса", добавлена загрузка из базы ФИАС (ГАР) справочинков Населенные пункты, Поселения, Муниципальные районы и их иерархия.
