...
namespace rosa.UploadData.Client
{
  public class ModuleFunctions
  {
    ...
    private Structures.Module.CaseFilesInfo CreateCaseFileSelectDialog(string inputDialogTitle)
    {
      ...
      if (dialog.Show() == DialogButtons.Ok)
      {
        ...
        return Structures.Module.CaseFilesInfo.Create(file.Value.Content,
                                                      ...
                                                      new List<rosa.UploadData.Structures.Module.CaseFile>());
      }
      else
        return null;
    }
    ...
    {
      var dialog = Dialogs.CreateInputDialog(rosa.UploadData.Resources.LoadCitiesDialogTitle);
      var file = dialog.AddFileSelect(Resources.FileSelectTitle, true).WithFilter(string.Empty, "xlsx");
      var country = dialog.AddSelect(rosa.UploadData.Resources.Country, true, Sungero.Commons.Countries.Null);
      var region = dialog.AddSelect(rosa.UploadData.Resources.Region, true, Sungero.Commons.Regions.Null);
